...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&pause=1000&color=00D9FF&center=true&vCenter=true&width=600&lines=Machine+Learning+%7C+Deep+Learning+%7C+LLMs;GCP+%7C+Spark+%7C+Airflow+%7C+Kafka;Data+Engineering+%7C+MLOps+%7C+Analytics;Open+to+Full-Time+Opportunities)](https://git.io/typing-svg)

[![Portfolio](https://img.shields.io/badge/🌐_Portfolio-000000?style=for-the-badge&logo=google-chrome&logoColor=white)](https://phanee16.github.io/)
...
![Profile Views](https://komarev.com/ghpvc/?username=phanee16&color=00D9FF&style=flat-square&label=Profile+Views)
![GitHub followers](https://img.shields.io/github/followers/phanee16?style=flat-square&color=00D9FF)
...
|---|---------|-------------|-------|
| 🗺️ | **[OptiRoute TSP Solver](https://github.com/phanee16/OptiRoute-Dynamic-TSP-Solver)** | Nearest-neighbor TSP solver with live geographic map visualization | `Python` `Folium` `Jupyter` |
| 🚦 | **[NYC Collision Analytics App](https://github.com/phanee16/-Web-Application-for-Analyzing-NYC-Collision-Data-)** | End-to-end web app: BigQuery ingestion → Streamlit dashboard → Looker Studio reports | `Python` `Streamlit` `GCP` `BigQuery` |
| 🧬 | **[Autism Detection via Genome Data](https://github.com/phanee16/-Comparative-Analysis-of-Boosting-Algorithms-for-Autism-Detection-using-Genome-Data-)** | Benchmarked RF, GBM, AdaBoost & XGBoost on high-dimensional genomic data | `R` `XGBoost` `Scikit-Learn` |
| 🎮 | **[SARSA Grid RL Agent](https://github.com/phanee16/Enhancing-Gaming-with-SARSA-Algorithm-Grid-based-Reinforcement-Learning)** | Trained a reinforcement learning agent using the SARSA algorithm | `Python` `OpenAI Gym` |
| 🔍 | **[Chicago Crime Analysis](https://github.com/phanee16/Crime-Data-Analysis)** | Geospatial + statistical analysis to uncover hidden crime patterns | `Python` `Pandas` `Folium` |
| 🤖 | **LLM Chatbot (Community Dreams Foundation)** | Domain-specific chatbot using LangChain + LLMs for personalized energy insights | `Python` `LangChain` `GCP` |
...
![BigQuery](https://img.shields.io/badge/BigQuery-FABC0C?style=flat-square&logo=google-cloud&logoColor=black)
...
<img height="165" src="https://github-readme-stats.vercel.app/api?username=phanee16&show_icons=true&theme=github_dark&hide_border=true&count_private=true&include_all_commits=true" />
<img height="165" src="https://github-readme-stats.vercel.app/api/top-langs/?username=phanee16&layout=compact&theme=github_dark&hide_border=true&langs_count=8" />

[![GitHub Streak](https://streak-stats.demolab.com?user=phanee16&theme=github-dark-blue&hide_border=true)](https://git.io/streak-stats)
...
```yaml
role:        Data Scientist — Team Lead (Volunteer)
company:     Community Dreams Foundation, USA
period:      Jul 2023 — Present

achievements:
  - Led team applying computer vision to energy data analysis
  - Built LLM-powered chatbot using LangChain for personalized interactions
  - Designed GCP database + Power BI / Tableau dashboards
  - Developed recommendation engine for personalized energy incentives
  - Integrated real-time web scraping pipeline for data acquisition

skills_used: [Python, GCP, BigQuery, LangChain, Tableau, Power BI, OpenCV, LLMs]
```
...
**Currently open to full-time Data Scientist & ML Engineer roles.**
...
[![Portfolio](https://img.shields.io/badge/View_Portfolio-000000?style=for-the-badge&logo=google-chrome&logoColor=white)](https://phanee16.github.io/)
